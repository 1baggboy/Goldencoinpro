...
export const Sidebar = ({ isOpen, onClose }: { isOpen?: boolean, onClose?: () => void }) => {
  ...
  return (
    <>
      ...
      <aside className={cn(
        "fixed md:static inset-y-0 left-0 w-64 bg-[#121212] border-r border-[#C9A96E]/20 flex flex-col z-[70] transition-transform duration-300 md:translate-x-0",
        ...
        <div className="p-6 flex items-center justify-between">
          ...
          <button onClick={onClose} className="p-2 text-gray-500 hover:text-white md:hidden">
            <X size={24} />
          </button>
        </div>
