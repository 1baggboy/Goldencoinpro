  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      if (err.code === "auth/popup-closed-by-user") {
        message = "Popup was closed before completing registration.";
        ...
        >
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-slate-900 px-3 text-slate-400 font-semibold tracking-wider">Or Register with</span>
            </div>
          </div>
