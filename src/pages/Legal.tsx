    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      >
        <div className="flex items-center gap-6 mb-12">
          ...
          <div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-950 dark:text-white uppercase font-display italic">{title}</h1>
            <p className="text-[#C9A96E] font-bold text-sm tracking-widest uppercase mt-2">Last updated: May 9, 2026</p>
          </div>
        </div>

        <div className="prose prose-slate dark:prose-invert prose-gold max-w-none space-y-12 text-slate-600 dark:text-gray-400 leading-relaxed border-t border-[#C9A96E]/10 pt-12">
          {children}
        </div>
      </motion.div>
    </div>
